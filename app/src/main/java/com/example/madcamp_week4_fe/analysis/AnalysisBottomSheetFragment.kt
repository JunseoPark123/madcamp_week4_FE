...
import com.example.madcamp_week4_fe.home.MarkerPagerAdapter
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class AnalysisBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_analysis_bottom_sheet, container, false)
        val viewPager: ViewPager2 = view.findViewById(R.id.viewPager)

        // sharedViewModel을 MarkerPagerAdapter에 전달
        viewPager.adapter = sharedViewModel?.let {AnalysisPagerAdapter(markerDataList, sharedViewModel!!)
        }
    ...
    companion object {
        fun newInstance(markerDataList: List<MarkerData>): AnalysisBottomSheetFragment {
            val fragment = AnalysisBottomSheetFragment()
            val args = Bundle()
